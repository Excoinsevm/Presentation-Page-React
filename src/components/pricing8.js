      ...
      <div className="pricing8-max-width thq-section-max-width">
        <div className="pricing8-section-title">
          <span>
            {props.content1 ?? (
              <Fragment>
                <span className="pricing8-text156 thq-body-small">
                  Pricing plans
                </span>
              </Fragment>
            )}
          ...
          <div className="pricing8-content">
            <h2>
              {props.heading1 ?? (
                <Fragment>
                  <h2 className="pricing8-text176 thq-heading-2">
                    Basic Plan Features
                  </h2>
                </Fragment>
              )}
            ...
            <p>
              {props.content2 ?? (
                <Fragment>
                  <p className="pricing8-text183 thq-body-large">
                    <span>
              ...
              <div className="pricing8-price10">
                <div className="pricing8-price11">
                  <p>
                    {props.plan1 ?? (
                      <Fragment>
                        <p className="pricing8-text196 thq-body-large">
                          Basic Plan
                        </p>
                      </Fragment>
                    )}
                  ...
                  <h3>
                    {props.plan1Price ?? (
                      <Fragment>
                        <h3 className="pricing8-text158 thq-heading-3">
                          $0/month
                        </h3>
                      </Fragment>
                    )}
                  ...
                  <p>
                    {props.plan1Yearly ?? (
                      <Fragment>
                        <p className="pricing8-text204 thq-body-large">
                          $0/year
                        </p>
                      </Fragment>
                    )}
                ...
                <div className="pricing8-list1">
                  <div className="pricing8-list-item10">
                    ...
                    <span>
                      {props.plan1Feature1 ?? (
                        <Fragment>
                          <span className="pricing8-text182 thq-body-small">
                  ...
                  <div className="pricing8-list-item11">
                    ...
                    <span>
                      {props.plan1Feature2 ?? (
                        <Fragment>
                          <span className="pricing8-text167 thq-body-small">
                  ...
                  <div className="pricing8-list-item12">
                    ...
                    <span>
                      {props.plan1Feature3 ?? (
                        <Fragment>
                          <span className="pricing8-text161 thq-body-small">
              ...
              <div className="pricing8-price12">
                <div className="pricing8-price13">
                  <p>
                    {props.plan2 ?? (
                      <Fragment>
                        <p className="pricing8-text155 thq-body-large">
                          Business plan
                        </p>
                      </Fragment>
                    )}
                  ...
                  <h3>
                    {props.plan2Price ?? (
                      <Fragment>
                        <h3 className="pricing8-text205 thq-heading-3">
                          $29/mo
                        </h3>
                      </Fragment>
                    )}
                  ...
                  <p>
                    {props.plan2Yearly ?? (
                      <Fragment>
                        <p className="pricing8-text168 thq-body-large">
                          or $299 yearly
                        </p>
                      </Fragment>
                    )}
            ...
            <div className="pricing8-column3 thq-card">
              ...
              <div className="pricing8-price14">
                <div className="pricing8-price15">
                  <p>
                    {props.plan3 ?? (
                      <Fragment>
                        <p className="pricing8-text202 thq-body-large">
                          Enterprise plan
                        </p>
                      </Fragment>
                    )}
                  ...
                  <h3>
                    {props.plan3Price ?? (
                      <Fragment>
                        <h3 className="pricing8-text166 thq-heading-3">
                          $49/mo
                        </h3>
                      </Fragment>
                    )}
                  ...
                  <p>
                    {props.plan3Yearly ?? (
                      <Fragment>
                        <p className="pricing8-text207 thq-body-large">
                          or $499 yearly
                        </p>
                      </Fragment>
                    )}
                ...
                <div className="pricing8-list3">
                  ...
                  <div className="pricing8-list-item18">
                    ...
                    <span>
                      {props.plan3Feature2 ?? (
                        <Fragment>
                          <span className="pricing8-text164 thq-body-small">
                            Feature text goes here
                          </span>
                        </Fragment>
                      )}
                  ...
                  <div className="pricing8-list-item21">
                    ...
                    <span>
                      {props.plan3Feature5 ?? (
                        <Fragment>
                          <span className="pricing8-text200 thq-body-small">
                            Feature text goes here
                          </span>
                        </Fragment>
                      )}
              ...
              <button className="pricing8-button16 thq-button-animated thq-button-filled">
                <span>
                  {props.plan3Action ?? (
                    <Fragment>
                      <span className="pricing8-text170 thq-body-small">
                        Get started
                      </span>
                    </Fragment>
                  )}
            ...
            <div className="pricing8-column4 thq-card">
              ...
              <div className="pricing8-price16">
                <div className="pricing8-price17">
                  <span>
                    {props.plan11 ?? (
                      <Fragment>
                        <span className="pricing8-text173 thq-body-large">
                          Basic plan
                        </span>
                      </Fragment>
                    )}
                  ...
                  <h3>
                    {props.plan1Price1 ?? (
                      <Fragment>
                        <h3 className="pricing8-text189 thq-heading-3">
                          $0 setup fee
                        </h3>
                      </Fragment>
                    )}
                  ...
                  <div className="pricing8-list-item23">
                    ...
                    <span>
                      {props.plan1Feature21 ?? (
                        <Fragment>
                          <span className="pricing8-text175 thq-body-small">
              ...
              <button className="pricing8-button17 thq-button-outline thq-button-animated">
                <span>
                  {props.plan1Action1 ?? (
                    <Fragment>
                      <span className="pricing8-text188 thq-body-small">
                        Get started
                      </span>
                    </Fragment>
                  )}
              ...
              <div className="pricing8-price18">
                <div className="pricing8-price19">
                  <span>
                    {props.plan21 ?? (
                      <Fragment>
                        <span className="pricing8-text206 thq-body-large">
                          Business plan
                        </span>
                      </Fragment>
                    )}
                  ...
                  <h3>
                    {props.plan2Price1 ?? (
                      <Fragment>
                        <h3 className="pricing8-text160 thq-heading-3">
                          $299/year
                        </h3>
                      </Fragment>
                    )}
                  ...
                  <span>
                    {props.plan2Yearly1 ?? (
                      <Fragment>
                        <span className="pricing8-text159 thq-body-large">
                          or $29 monthly
                        </span>
                      </Fragment>
                    )}
                  ...
                  <div className="pricing8-list-item26">
                    ...
                    <span>
                      {props.plan2Feature21 ?? (
                        <Fragment>
                          <span className="pricing8-text198 thq-body-small">
                            Feature text goes here
                          </span>
                        </Fragment>
                      )}
            ...
            <div className="pricing8-column6 thq-card">
              ...
              <div className="pricing8-price20">
                <div className="pricing8-price21">
                  <span>
                    {props.plan31 ?? (
                      <Fragment>
                        <span className="pricing8-text157 thq-body-large">
                          Enterprise plan
                        </span>
                      </Fragment>
                    )}
                  ...
                  <h3>
                    {props.plan3Price1 ?? (
                      <Fragment>
                        <h3 className="pricing8-text162 thq-heading-3">
                          $499/year
                        </h3>
                      </Fragment>
                    )}
                  ...
                  <span>
                    {props.plan3Yearly1 ?? (
                      <Fragment>
                        <span className="pricing8-text169 thq-body-large">
                          or $49 monthly
                        </span>
                      </Fragment>
                    )}
                  ...
                  <div className="pricing8-list-item32">
                    ...
                    <span>
                      {props.plan3Feature41 ?? (
                        <Fragment>
                          <span className="pricing8-text181 thq-body-small">
                            Feature text goes here
                          </span>
                        </Fragment>
                      )}
                  ...
                  <div className="pricing8-list-item33">
                    ...
                    <span>
                      {props.plan3Feature51 ?? (
                        <Fragment>
                          <span className="pricing8-text203 thq-body-small">
                            Feature text goes here
                          </span>
                        </Fragment>
                      )}
              ...
              <button className="pricing8-button19 thq-button-animated thq-button-filled">
                <span>
                  {props.plan3Action1 ?? (
                    <Fragment>
                      <span className="pricing8-text180 thq-body-small">
                        Get started
                      </span>
                    </Fragment>
                  )}
