              ...
              <div className="footer1-form">
                ...
                <button className="thq-button-outline footer1-button">
                  <span>
                    {props.action1 ?? (
                      <Fragment>
                        <span className="footer1-text27 thq-body-small">
          ...
          <div className="footer1-links">
            <div className="footer1-column1">
              <strong>
                {props.column1Title ?? (
                  <Fragment>
                    <strong className="footer1-text12 thq-body-large">
                      Company
                    </strong>
                  </Fragment>
                )}
            ...
            <div className="footer1-column2">
              <strong>
                {props.column2Title ?? (
                  <Fragment>
                    <strong className="footer1-text17 thq-body-large">
                      Services
                    </strong>
                  </Fragment>
                )}
              ...
              <div className="footer1-footer-links2">
                ...
                >
                  {props.link10 ?? (
                    <Fragment>
                      <span className="footer1-text13 thq-body-small">
                        Terms of Service
                      </span>
                    </Fragment>
                  )}
            ...
            <div className="footer1-column3">
              <strong>
                {props.socialLinkTitleCategory ?? (
                  <Fragment>
                    <strong className="footer1-text20 thq-body-large">
                      Connect with Us
                    </strong>
                  </Fragment>
                )}
          ...
          <div className="footer1-row">
            ...
            <div className="footer1-footer-links3">
              ...
              <span>
                {props.termsLink ?? (
                  <Fragment>
                    <span className="footer1-text10 thq-body-small">
                      /terms
                    </span>
                  </Fragment>
                )}
